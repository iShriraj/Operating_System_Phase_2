...
public class Phase2
{
	...
	{
		//clear output file
		PrintWriter writer = new PrintWriter("C:\\Users\\abhis\\Desktop\\output.txt");
		writer.println("");
		writer.close();
		...
		//Auto open file
		ProcessBuilder pb1=new ProcessBuilder("Notepad.exe","C:\\Users\\abhis\\Desktop\\output.txt");
		pb1.start();
	}
	...
	private static void writeTwoBlankLines()
	{
		...
		File file = new File("C:\\Users\\abhis\\Desktop\\output.txt");
		FileWriter fr = null;
	...
	void Load()
	{
		...
		File file = new File("C:\\Users\\abhis\\Desktop\\inputfile.txt");
...
//				int radd=0;
//				for(int i=0;i < current_card.length()-1;i+=4,row_number++)
//				{
//					for(j=0;j < 4;j++)
//					{
//						radd=FrameNumber+row_number;
//						M[radd][j] = current_card.charAt(i+j); 
//					}
//				}
